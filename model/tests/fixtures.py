...
def model_base():
    scenario_dir = Path("experiments/usa/scenario_base/")
...
def model_screening():
    scenario_dir = Path("experiments/usa/scenario_screening/")
...
def model_vaccination():
    scenario_dir = Path("experiments/usa/scenario_vaccination/")
